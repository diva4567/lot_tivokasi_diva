...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    HTTPClient http;
    String url = "http://2e96-103-124-138-26.ngrok-free.app/api/posts"; // Ganti dengan URL ngrok yang benar
...
String payload = "{\"nama_sensor\":\"Sensor GD\", \"nilai1\":50, \"nilai2\":30}";
